...
export function About() {
  ...
  const defaultInfo = {
    title: "소개",
    subtitle: "단국대학교 학생군사교육단",
    background: {"image":"","video":"","color":"","opacity":0.1},
    experienceCards: [{"icon":"briefcase","title":"제125학생군사교육단","period":"2015 - 현재","description":"후보생 군사교육, 훈육"},{"icon":"graduation","title":"단국대학교 부동산건설대학원","period":"2024 - 현재","description":"전공 : 도시 및 부동산 개발학과"},{"icon":"award","title":"주요 경력","period":"육군3사관학교 35기 임관","description":"특전사, 제1야전사령부 / 지휘관 및 참모, 동티모르 상록수부대 해외파병"}],
    skills: [{"icon":"code","title":"모집기간","description":"2025.09.01(월)~10.14(화), 24:00한"},{"icon":"database","title":"선발 과정","description":"인터넷 접수-국민체력인증-신체검사-대면 면접-신원조사\n"},{"icon":"palette","title":"최종 합격자 발표","description":"2025. 12. 10(수), 14:00"}],
    storyTitle: "죽전캠퍼스(제125학생군사교육단)",
    story: ["<<제125 학생군사교육단 소개>>\n\n제125단국대학군단은 1965년 무한한 가능성과 잠재력을 갖고 있는 대학생중 우수자를 선발, 2년간 군사훈련을 통하여 학문과 인격을 겸비시킨후 졸업과 동시에 장교로 임관, 군대 조직사회에서 개인의 책임감 및 사명감을 함양하고 창의력과 리더십을 배양하여 국가발전을 주도하는 역군으로 활용하기 위하여 창설하였습니다.","○ 학군후보생 대학 생활\n  -초급장교 소양 구비 : 각종 자격증 취득, 체력 증진을 통해 기본소양을 구비\n  -리더십, 지성 연마 : 전적지 답사, 해외전사적지탐방, 초청 강연 등으로 이론에서 벗어나 실제를 체험하는 기회를 갖고, 군의 간부 그리고 사회의 리더가 될 후보생으로서의 지성을 함양\n  -단웅무제 : 태권도, 예도, 장기자랑 등 보여주지 못했던 후보생들의 끼를 발산하며 문무를 겸비한 후보생의 축제","○ 학군단 건물 : 학군단 전용 3층 독립건물과 전용 연병장(풋살장)을 보유","○ 교내교육 및 입영훈련\n  -교내교육 : 학기별 주 2회(월,금) 분산 수업 / 학기별 3학점 부여\n  -입영훈련(12주) : 기초군사훈련 4주, 3학년 하계입영(4주), 4학년 하계입영(4주)","○ 후보생 혜택\n  [국방부 지원 혜택]\n  -단기복무 장려금(1200만원, 3학년 입단시 1회 지급)\n  -학군생활 지원금(18만원 *20개월 = 360만원)\n  -교보재비(6만8천원 * 24개월 = 163만원)\n  -입영 훈련비(일할계산) : 약 150만원~165만원"," [단국대 지원 혜택]\n  -추가 장학금 지급(학군리더 장학금, 125ROTC총동문회 장학금, 자치근무자 봉사장학금 등)\n  -국내,외 전사적지 및 문화탐방 지원\n  -생활관 입주 희망시 우선 선발\n  -학군단 전용 헬스장, 학습실, 북카페, 휴게실 등 편의시설 제공","○ 임관 후 혜택\n  -전공과 연계된 근무 기회(의대, 로스쿨 등 군에서 입학 가능)\n  -장기복무자 자기계발 기회 제공\n  -다양한 여가지원(패밀리레스토랑, 영화관, 아쿠아리움 할인 등)\n  -군 복지시설 이용 혜택(군병원, 휴양시설, 충성클럽(영내 및 영외 PX)\n  -군 숙소 지원","새로운 문단"],
    storyImage: "/uploads/about-image-1762909650048.jpg",
    hobbies: ["단부건 산악회","35대 원우회","수영,테니스","스쿠버다이빙"]
  }
