...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"briefcase","title":"제125학생군사교육단","period":"2015 - 현재","description":"후보생 군사교육, 훈육"},{"icon":"graduation","title":"단국대학교 부동산건설대학원","period":"2024 - 현재","description":"전공 : 도시 및 부동산 개발학과"},{"icon":"award","title":"주요 경력","period":"육군3사관학교 35기 임관","description":"제1공수특전여단 중대장/참모"}],
